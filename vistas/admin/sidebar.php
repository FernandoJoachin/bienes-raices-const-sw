<aside class="dashboard__sidebar">
  <nav class="dashboard__menu">
    <a href="/admin-inicio" class="dashboard__enlace  <?php echo validarPaginaActual("/admin-inicio") ? "dashboard__enlace--actual" : ""; ?>">
    ...
    <a href="/admin/propiedades" class="dashboard__enlace <?php echo validarPaginaActual("/propiedades") ? "dashboard__enlace--actual" : ""; ?>">
    ...
    <?php if($_SESSION["esAdmin"] == 1){?>
      <a href="/admin/usuarios" class="dashboard__enlace <?php echo validarPaginaActual("/usuarios") ? "dashboard__enlace--actual" : ""; ?>">
        ...
        <span class="dashboard__menu-texto">Admin</span>
      </a>
    <?php }?>
  </nav>
</aside>